...
HGraph.prototype.zoomIn = function (zoomFactor, x, y) {
    ...
    var key, i, j, factor, details, layer, labels, that, zoomedWebFillString, getZoomedRingPath, getZoomedX, getZoomedY,
        scoreRange;
...
HGraph.prototype.addPoint = function (datapoint, index, startingAngle, increment, steps, startingScoreRange, sortIndex, labelWithDetail) {
    ...
    var point, secondary, angle, coords, radius, getPointColor, getTextAnchor, gotoPage, interstitialScore,
        startingDataValue, startingCoords, scoreDiff, scaledDataValue, labelPointScale, metricValue;
